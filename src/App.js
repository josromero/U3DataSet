...
function App() {
  return (
    ...
    <div align="center">
    <CSVLink data={tabladatos} filename="tabladatos.csv"><button className="btn btn-primary">Exportar como CSV</button></CSVLink>
    <br></br>
    <br></br>
    <Pdf targetRef={ref} filename="tabladatos.pdf" const size = "A4">
